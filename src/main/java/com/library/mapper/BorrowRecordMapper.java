...
public interface BorrowRecordMapper {
     ...
     * 分页查询借阅记录（含详情）
     */
    List<BorrowRecordDTO> selectWithDetailsByPage(@Param("studentId") Integer studentId, @Param("offset") Integer offset, @Param("limit") Integer limit);

    /**
     * 查询借阅记录总数
     */
    int selectCount(@Param("studentId") Integer studentId);
