...
public class BorrowServiceImpl implements BorrowService {
    ...
    @Override
    public List<BorrowRecordDTO> getRecordsWithDetailsByPage(Integer studentId, Integer page, Integer size) {
        Integer offset = (page - 1) * size;
        return borrowRecordMapper.selectWithDetailsByPage(studentId, offset, size);
    }
